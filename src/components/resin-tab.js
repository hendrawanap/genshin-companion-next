    ...
    <div className={`border border-dark-15 rounded-xl flex items-center p-4 tracking-wider`}>
      ...
      <div className="flex flex-col justify-between w-full self-stretch">
        <div className="row-1">
          ...
          <div className="angka">
            <span className="text-3xl font-bold text-danger text-opacity-high">{ originalResin }</span><span className="text-xs text-white text-opacity-30 font-medium">/100</span>
          </div>
        </div>
      ...
      <div className="flex flex-col justify-between w-full self-stretch">
        <div className="row-1">
          ...
          <div className="angka">
            <h2 className="text-3xl font-bold text-primary text-opacity-high">12:33</h2>
          </div>
        </div>
        <div className="text-xs text-white text-opacity-30 font-medium">
          (0h 13m)
